...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a   class="w3-bar-item w3-button w3-padding  w3-text-teal"><i class="fa fa-align-justify fa-fw w3-margin-right"></i>Register</a> 
  ...
  <table>
    ...
    <?php
                ...
                while($row= $result->fetch_assoc()){
                    ...
                    <td>$row[location]</td>
                    <td>
                    <a class='button1 button4' href='edit1.php?id=$row[id]'>Edit</a>
